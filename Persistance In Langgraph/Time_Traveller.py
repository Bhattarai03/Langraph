...
async def main():
    ...
    initial_state={'topic':"Web Developer"}
    final_state=await workflow.ainvoke(initial_state,config=config)
    print(final_state)
    #For last saved history
    print(list(await workflow.aget_state({'configurable': {'thread_id': 'chat_session_1','checkpoint_id': '1f1919dd-b0de-6ffa-8001-fceb1b775b8e'}})))
    #For chat history
    while False:
        history_list=[]
